...
P,Q=O.length,R=0,S=[],T=parseInt(d.p.rowNum,10),U=d.p.scroll?$.jgrid.randId():1,V=$("#"+$.jgrid.jqID(d.p.id)+" tbody:first");if(Q>0&&d.p.IPage<=0&&(d.p.page=1),O&&Q){e&&(T*=e+1);var
...
b,c,e=d.p.scroll&&a===!1,f={},g=d.p.prmNames;d.p.IPage<=0&&(d.p.page=Math.min(1,d.p.lastpage)),null!==g.search&&(f[g.search]=d.p.search),null!==g.nd&&(f[g.nd]=(new
